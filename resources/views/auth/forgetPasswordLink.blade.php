        ...
        <div class="container-fluid h-custom" style="position: absolute;top: 50%;transform: translateY(-50%);">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <h3 class="mb-5 text-center">Đặt lại mật khẩu </h3>
                    <form action="{{ route('reset.password.post')}}" method="POST">
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <label class="form-label" for="form3Example4">Nhập mật khẩu</label>
                        </div>
                        ...
                        <!-- Retype Password -->
                        <div class="form-outline mb-3">
                            <input type="password" name="password_confirmation" id="form3Example4" class="form-control form-control-lg" placeholder="Enter password" />
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Lưu lại</button>
                        </div>
